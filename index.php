...
<body>
    <div class="container position-absolute top-50 start-50 translate-middle">
        <h1 class="d-flex justify-content-center" style="color: #ececec; font-size: 3rem; font-weight: bolder;">
            Calculator
        </h1>
        <form action="POST" class="col buttons form">
            <!-- Results -->
            <div class="row d-flex justify-content-center m-5">
                <input type="text" class="col-1 border-0" id="calcul" name="calcul">
                <input type="text" class="col-1 border-0" id="currentNumber" name="result">
            </div>
            <!-- Buttons -->
            <div class="row">
